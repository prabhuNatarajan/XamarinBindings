...
{
	ScrollPerPageTransition,     // default mode for iOS4. Has one scrollView per page.
	
	ScrollContinuousTransition,  // new in PSPDFKit v2. One global scrollView.
	CurlTransition,              // replaces pageCurlEnabled.
	FlipTransition               // Flipboard-like; new in PSPDFKit v2. EXPERIMENTAL!
}
