...
namespace AlexTouch.PSPDFKit {
	...
	public unsafe partial class PSPDFLinkAnnotationBaseView : MonoTouch.UIKit.UIView {
		static readonly IntPtr selLinkAnnotation = Selector.GetHandle ("linkAnnotation");
		...
		public virtual PSPDFLinkAnnotation LinkAnnotation {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (PSPDFLinkAnnotation) Runtime.GetNSObject (MonoTouch.ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selLinkAnnotation));
				} else {
					ret = (PSPDFLinkAnnotation) Runtime.GetNSObject (MonoTouch.ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, selLinkAnnotation));
				}
				MarkDirty ();
