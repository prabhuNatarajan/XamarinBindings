...
namespace AlexTouch.PSPDFKit {
	[Register("PSPDFDocumentProviderDelegate", true)]
	[Model]
	public unsafe partial class PSPDFDocumentProviderDelegate : NSObject {
		...
		public PSPDFDocumentProviderDelegate (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
			if (IsDirectBinding) {
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public PSPDFDocumentProviderDelegate (NSObjectFlag t) : base (t) {}

		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public PSPDFDocumentProviderDelegate (IntPtr handle) : base (handle) {}
