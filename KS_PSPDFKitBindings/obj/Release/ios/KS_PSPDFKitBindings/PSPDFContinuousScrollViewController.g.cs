...
namespace KS_PSPDFKitBindings {
	[Register("PSPDFContinuousScrollViewController", true)]
	public unsafe partial class PSPDFContinuousScrollViewController : PSPDFBaseViewController {
		[CompilerGenerated]
		...
		[CompilerGenerated]
		const string selCompensatedContentOffset = "compensatedContentOffset";
		static readonly IntPtr selCompensatedContentOffsetHandle = Selector.GetHandle ("compensatedContentOffset");
		[CompilerGenerated]
		...
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("PSPDFContinuousScrollViewController");
		...
		[Export ("init")]
		public PSPDFContinuousScrollViewController () : base (NSObjectFlag.Empty)
		{
		...
		public PSPDFContinuousScrollViewController (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
			if (IsDirectBinding) {
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public PSPDFContinuousScrollViewController (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public PSPDFContinuousScrollViewController (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		public PSPDFContinuousScrollViewController (PSPDFViewController pdfController)
		...
		[CompilerGenerated]
		public virtual global::System.Drawing.PointF CompensatedContentOffset {
			[Export ("compensatedContentOffset")]
			get {
				global::System.Drawing.PointF ret;
				if (IsDirectBinding) {
					if (Runtime.Arch == Arch.DEVICE){
						MonoTouch.ObjCRuntime.Messaging.PointF_objc_msgSend_stret (out ret, this.Handle, selCompensatedContentOffsetHandle);
					} else {
						ret = MonoTouch.ObjCRuntime.Messaging.PointF_objc_msgSend (this.Handle, selCompensatedContentOffsetHandle);
					}
				} else {
					if (Runtime.Arch == Arch.DEVICE){
						MonoTouch.ObjCRuntime.Messaging.PointF_objc_msgSendSuper_stret (out ret, this.SuperHandle, selCompensatedContentOffsetHandle);
					} else {
						ret = MonoTouch.ObjCRuntime.Messaging.PointF_objc_msgSendSuper (this.SuperHandle, selCompensatedContentOffsetHandle);
					}
				}
				return ret;
			}
	...
	} /* class PSPDFContinuousScrollViewController */
}
