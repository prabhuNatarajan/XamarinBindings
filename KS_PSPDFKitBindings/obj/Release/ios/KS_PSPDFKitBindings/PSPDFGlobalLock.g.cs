...
namespace KS_PSPDFKitBindings {
	...
	public unsafe partial class PSPDFGlobalLock : NSObject {
		[CompilerGenerated]
		const string selSharedGlobalLock = "sharedGlobalLock";
		static readonly IntPtr selSharedGlobalLockHandle = Selector.GetHandle ("sharedGlobalLock");
		...
		{
			return (PSPDFGlobalLock) Runtime.GetNSObject (MonoTouch.ObjCRuntime.Messaging.IntPtr_objc_msgSend (class_ptr, selSharedGlobalLockHandle));
		}
